...
class PrimaryColorLight {
  static const Color barbera = Color(0xFFD1870B);
  static const Color belila = Color(0xFF30B319);
  static const Color bellcommerce = Color(0xFF40BFFF);
  static const Color coffiy = Color(0xFFBB7F67);
  static const Color foodiy = Color(0xFFFF0303);
  static const Color furney = Color(0xFF5866A4);
  static const Color lestate = Color(0xFF1B1839);
  static const Color movlix = Color(0xFFFC4F03);
  static const Color shuppy = Color(0xFFF6402E);
  static const Color treshop = Color(0xFFFC8080);
  static const Color furniture1 = Color(0xFF31364C);
}

class PrimaryColorDark {
  static const Color barbera = Color(0xFFD1870B);
  static const Color belila = Color(0xFF30B319);
  static const Color bellcommerce = Color(0xFF40BFFF);
  static const Color coffiy = Color(0xFFE0C097);
  static const Color foodiy = Color(0xFFFF0303);
  static const Color furney = Color(0xFF5866A4);
  static const Color lestate = Color(0xFFFA7096);
  static const Color movlix = Color(0xFFFC4F03);
  static const Color shuppy = Color(0xFFF6402E);
  static const Color treshop = Color(0xFFFC8080);
  static const Color furniture1 = Color(0xFF31364C);
...
class AccentColorLight {
  static const Color furniture1 = Color(0xFFFF6600);
}

class AccentColorDark {
  static const Color furniture1 = Color(0xFFFF6600);
}

...
List<UIKitModels> premiumList(BuildContext context) => [
      UIKitModels(
        name: 'Barbera | Barbershop UI Kit',
        description: AppLocalizations.of(context)!.barbera_barbershop_UI_Kit_is_an_application_for_finding_and_barber_appointments_at_the_nearest_barbershop_It_has_50_Screens_which_includes_all_the_features_and_is_designed_as_much_as_possible_so_that_users_can_use_the_application_easily,
      ...
      UIKitModels(
        ...
        description: AppLocalizations.of(context)!.bellcommerce_is_an_ecommerce_application_that_is_used_by_people_to_sell_all_kinds_of_categories_of_goods_Bellcommerce_is_neatly_designed_clean_and_modern_and_has_27_Screens,
        type: TypeScreen.uikit,
        isPremium: true,
        purchaseLink: 'https://codecanyon.net/item/flutter-ui-master-kit/34146810',
        heroImage:
      ...
      UIKitModels(
        ...
        description: AppLocalizations.of(context)!.lestate_is_a_unique_Real_Estate_Web_UI_Kit_with_detailed_criteria_and_input_fields_based_on_user_feedback_from_Real_Estate_Agents_Be_a_Pro_get_a_head_start_on_the_User_Experience_Has_30_Screens_clean_and_modern,
        type: TypeScreen.uikit,
        isPremium: true,
        purchaseLink: 'https://codecanyon.net/item/flutter-ui-master-kit/34146810',
        heroImage: 'https://i.pinimg.com/originals/68/fe/2f/68fe2fa4d45fd23c0e16f7eed04d86ef.jpg',
        detailImages: [
      ...
      UIKitModels(
        ...
        description: AppLocalizations.of(context)!.treshop_Flutter_eCommerce_UI_Kit_is_a_nicely_designed_and_developed_mobile_application_UI_kit_developed_using_Flutter_Flutter_is_an_opensource_mobile_application_development_SDK_created_by_Google_and_used_to_develop_applications_for_Android_and_iOS,
        type: TypeScreen.uikit,
        isPremium: true,
        purchaseLink: 'https://codecanyon.net/item/flutter-ui-master-kit/34146810',
        heroImage: 'https://i.pinimg.com/originals/b9/f5/7e/b9f57e7828d7cb5648aa3c8abdb76894.jpg',
        detailImages: [
      ...
      UIKitModels(
        ...
        description: AppLocalizations.of(context)!.foodiy_is_a_Food_Delivery_App_this_app_helps_users_to_order_their_food_with_the_market_like_a_restaurant,
        type: TypeScreen.uikit,
        isPremium: true,
        purchaseLink: 'https://codecanyon.net/item/flutter-ui-master-kit/34146810',
        heroImage: 'https://i.pinimg.com/originals/8c/92/c2/8c92c217e01fad9db1e0f2e8ba48b82e.jpg',
        detailImages: [
      ...
      UIKitModels(
        ...
        description: AppLocalizations.of(context)!.furney_furniture_mobile_app_UI_kit_Which_allows_users_to_order_various_quality_furniture_but_not_have_to_go_to_places_It_also_helps_users_search_for_ideas_from_other_people_to_decorate_their_homes,
        type: TypeScreen.uikit,
        isPremium: true,
        purchaseLink: 'https://codecanyon.net/item/flutter-ui-master-kit/34146810',
        heroImage: 'https://i.pinimg.com/originals/55/aa/88/55aa882e7ac9d0038ffe072e8666b2dc.jpg',
        detailImages: [
      ...
      UIKitModels(
        ...
        description: AppLocalizations.of(context)!.coffiy_Coffee_Shop_UI_Kit_app_design_project_the_design_made_for_help_your_projects_and_can_be_generate_new_idea,
        type: TypeScreen.uikit,
        isPremium: true,
        purchaseLink: 'https://codecanyon.net/item/flutter-ui-master-kit/34146810',
        heroImage: 'https://i.pinimg.com/originals/b8/dc/ec/b8dcec7807cf08cb0abaf1ed4801bafb.jpg',
        detailImages: [
      ...
      UIKitModels(
        ...
        description: AppLocalizations.of(context)!.shuppy_is_a_premium_ecommerce_UI_Kit_focused_for_modern_luxury_elegant_products_With_over_23_screens_its_all_you_need_to_quickly_design_your_next_app_The_purpose_of_this_UI_Kit_is_to_be_an_accelerator_in_the_process_of_designing_any_user_interface_for_the_mobile_apps_it_is_designed_specifically_for_designers_developers_startups_and_agencies_that_want_to_quickly_boost_their_workflow_and_impress_the_clients,
        type: TypeScreen.uikit,
        isPremium: true,
        purchaseLink: 'https://codecanyon.net/item/flutter-ui-master-kit/34146810',
        heroImage: 'https://i.pinimg.com/originals/22/45/0f/22450fbe55ccc627cb78039ed486cb67.jpg',
        detailImages: [
      ...
      UIKitModels(
        ...
        description: AppLocalizations.of(context)!.belila_eCommerce_Mobile_App_UI_Kit_These_ecommerce_mobile_apps_iOS_Android_are_very_easy_to_use_I_can_easily_buy_any_product_as_per_your_choice_You_can_order_from_the_online_shop_in_your_home_We_have_come_up_with_all_kinds_of_new_products_for_both_boys_and_girls_or_anything,
        type: TypeScreen.uikit,
        isPremium: true,
        purchaseLink: 'https://codecanyon.net/item/flutter-ui-master-kit/34146810',
        heroImage: 'https://i.pinimg.com/originals/21/24/5f/21245f1283f0db68b8f38156d7136664.jpg',
        detailImages: [
      ...
      UIKitModels(
        ...
        description: AppLocalizations.of(context)!.high_quality_UI_Kits_pack_of_7_Movie_Streaming_based_app_screens_which_will_help_you_develop_an_app_with_outstanding_designs,
        type: TypeScreen.uikit,
        isPremium: true,
        purchaseLink: 'https://codecanyon.net/item/flutter-ui-master-kit/34146810',
        heroImage: 'https://i.pinimg.com/originals/64/03/a3/6403a3eece7ac209a9528eaae12fb7f6.jpg',
        detailImages: [
